...
"""
PyInstaller spec file for Share Buyback Strategy Streamlit App.

Build with: pyinstaller ShareBuybackApp.spec --clean
Output: dist/ShareBuybackStrategy.exe
"""
